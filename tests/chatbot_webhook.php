...
$cases = [
    ...
    ['id' => 'T74', 'message' => 'RTX 6090 giá bao nhiêu?', 'assert' => static fn (string $r): bool => containsAny($r, ['không có', 'chưa tìm thấy', 'không tìm thấy']) && !hasValidProductLink($r), 'reason' => 'Không được bịa giá hoặc link RTX 6090.'],
