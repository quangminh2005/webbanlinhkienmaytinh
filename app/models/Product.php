...
class Product
{
    ...
    public function create(array $data): void
    {
        $stmt = Database::connection()->prepare(
            'INSERT INTO products (category_id, name, price, stock_quantity, description, image_url, socket, ram_type, vram_gb, wattage)
             VALUES (:category_id, :name, :price, :stock_quantity, :description, :image_url, :socket, :ram_type, :vram_gb, :wattage)'
        );
        $stmt->execute($data);
    }
